...
namespace IncomeAndExpensesTrackingSystem
{
    public partial class CategoryForm : UserControl
    {
        ...
        private void catergory_addBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                using (SqlConnection connect = new SqlConnection(stringConnection))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(insertData, connect)) 
                    {
                        ...
                        cmd.Parameters.AddWithValue("@desc", category_status.SelectedItem);
                        cmd.Parameters.AddWithValue("@date_in", category_status.SelectedItem);
